...
- **Agent Card:**
    ...
    - See details in the [Protocol Specification: Agent Card](spec/index.md#5-agent-discovery-the-agent-card).
...
- **Task:**
    ...
    - See details in the [Protocol Specification: Task Object](spec/index.md#61-task-object).
...
- **Message:**
    ...
    - See details in the [Protocol Specification: Message Object](spec/index.md#64-message-object).
...
- **Part:**
    ...
    - See details in the [Protocol Specification: Part Union Type](spec/index.md#65-part-union-type).
...
- **Artifact:**
    ...
    - See details in the [Protocol Specification: Artifact Object](spec/index.md#67-artifact-object).
